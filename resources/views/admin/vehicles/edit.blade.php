    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="{{ route('admin.vehicles.index') }}" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Back</a>
            </div>
            ...
            @method('PUT')
                ...
                <div class="sm:col-span-6">
                    ...
                    <div>
                        <img class="w-32 h-32" src="{{ Storage::url($vehicle->image) }}">
                    </div>
                    <div class="mt-1">
